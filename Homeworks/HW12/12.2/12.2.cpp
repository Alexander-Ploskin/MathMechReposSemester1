...
bool test()
{
	...
	adjacencyMatrixTest1 = createMinimumSpenningTree(adjacencyMatrixTest1, numberOfVertexes1);
...
int main()
{
	...
	int** minimumSpenningTree = createMinimumSpenningTree(adjacencyMatrix, numberOfVertexes);
